...
image_data_lst = df['unit1_rgb3'].values # Image
...
def create_img_beam_dataset():
    ...
    df_new['unit1_rgb3'] = updated_img_path  # image
    ...
    df_new.to_csv(fr'./{folder_to_save}/scenario36_64_img_beam.csv', index=False)       
    ...
    train.to_csv(f'./{folder_to_save}/scenario36_64_img_beam_train.csv', index=False)
    val.to_csv(f'./{folder_to_save}/scenario36_64_img_beam_val.csv', index=False)
    test.to_csv(f'./{folder_to_save}/scenario36_64_img_beam_test.csv', index=False)    
